...
## 8. 基础设施正在从"为人设计"变为"为 Agent 设计"——这不是修辞
...
## 10. PUBG Ally 的 System 1/2 工程化是最干净的物理 AI 参考架构

**在物理交互场景中，延迟 > 智能**

玩家的偏好验证了这个架构——"在最重要的'响应速度和存在感'维度上，玩家始终偏好 SLM 而非云端大模型"。

## 11. 记忆系统的"和谐组织"原理正在收敛到统一设计
...
## 14. 最后再说一次：真正的瓶颈是"知道该做什么"，不是"能做多好"
...
## 15. 推测解码（Speculative Decoding）的热度被严重低估
...
## 16. NVIDIA 的物理 AI 战略正在形成完整的平台级布局
...
## 17. Modal 的"自动推理 + 自动推测 + 自动蒸馏 + 自动研究"四阶梯是 Agent 未来的方向
...
## 18. 有状态 Agent 的评估挑战是"业务逻辑"，不是"技术问题"
...
## 19. WBench 的"导航与画质正交"是 2026 年最深刻的 AI 发现之一
...
## 24. Simon Willison 的 Moebius 移植 = "vibe coding"的生产力极限
...
## 25. ParseBench 的"每 10 页有 1 页有错"——面向 Agent 的质量标准还远未建立
...
## 26. Andrew Ng 的三循环工程 = LangChain 四层的"用户视角版"
...
## 28. 2026 年 AI 工程的 13 条核心设计原则（合并版）
...
## 29. NVFP4 Four-over-Six 缩放——硬件创新需要算法创新来激活
...
## 31. SmithDB L0/L1 双层存储——"亚秒级新鲜度"不需要并行系统
...
## 32. AI-Q on OCI——Agent 部署从"实验室"走向"基础设施即代码"
...
## 33. Agent 开发生命周期（ADLC）——从"模型实验"到"软件工程"
